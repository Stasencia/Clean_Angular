...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20191205231315_TicketSeat")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.ScheduledEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("TheatricalEventId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("TheatricalEventId");
            ...
            modelBuilder.Entity("Core.Entities.TheatricalEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.TicketSeat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Entities.ScheduledEvent", b =>
                {
                    b.HasOne("Core.Entities.TheatricalEvent", "TheatricalEvent")
                        .WithMany("ScheduledEvents")
                        .HasForeignKey("TheatricalEventId")
            ...
            modelBuilder.Entity("Core.Entities.Ticket", b =>
                {
                    b.HasOne("Core.Entities.ScheduledEvent", "ScheduledEvent")
                        .WithMany("Tickets")
